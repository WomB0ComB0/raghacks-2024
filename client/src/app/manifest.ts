...
export default function manifest(): ExtendedManifest {
  return {
    name: 'Proximity Finder',
    short_name: 'PF',
    description:
      'Proximity Finder is an application that helps users discover nearby points of interest based on their current location. It provides quick and easy access to information about restaurants, cafes, parks, and other local attractions.',
    categories: [
      'location',
      'restaurant',
      'cafe',
